...
**文件：** `src/mewcode/permission/__init__.py`
**依赖：** 无
**步骤：**
...
**文件：** `src/mewcode/permission/blacklist.py`
**依赖：** 无
**步骤：**
...
**文件：** `src/mewcode/permission/sandbox.py`
**依赖：** 无
**步骤：**
...
**文件：** `src/mewcode/permission/rule.py`
**依赖：** 无
**步骤：**
...
**文件：** `src/mewcode/permission/settings.py`
**依赖：** T1, T4
**步骤：**
...
**文件：** `src/mewcode/permission/engine.py`
**依赖：** T1, T2, T3, T4, T5
**步骤：**
...
**文件：** `src/mewcode/permission/persist.py`
**依赖：** T5, T6
**步骤：**
...
**文件：** `src/mewcode/agent.py`
**依赖：** T6, T7
**步骤：**
1. **模式迁移**：删除 agent 内 `Mode`/`MODE_NORMAL`/`MODE_PLAN` 定义，`from mewcode.permission import Mode`，全部改用 `Mode.DEFAULT`/`Mode.PLAN`；`run` 形参 `mode: Mode`；`mode == Mode.PLAN` 处不变（defs 选只读、plan_reminder 注入）。
...
**文件：** `src/mewcode/cli.py`、`smoke/main.py`、`.gitignore`、`.mewcode/settings.yaml.example`
**依赖：** T6, T8, T10
**步骤：**
